        ...
        <div className="  bg-no-repeat sm:bg-no-repeat sm:bg-cover h-screen  " style={{ backgroundImage: `url(${imageURL})` }} >
            <div className='sm:mx-20 grid grid-cols-1  sm:grid-cols-2'>
                ...
                <div className="bg-black flex justify-center items-center flex-col ">
                    <h2 className='uppercase text-white  -tracking-tighter text-center py-5 sm:py-5 sm:text-3xl text-3xl font-semibold mt-5  font-nunito text-opacity-70'>About Us</h2>

                    <p className='text-white text-center mx-10 text-base sm:text-base text-opacity-50 font-nunito -tracking-tighter'>We specialize in nature photography,family and senior portraits, often traveling to your destination to
                        capture the perfect moment in the perfect place.</p>
                    <ul className="uppercase text-pink-500 text-center sm:m-10 m-5 text-base sm:text-base font-nunito flex justify-center items-center flex-col">


                        <li className='border border-pink-500 rounded p-3 w-40 hover:border-green-500 hover:text-green-500'><a href="#">Background</a>
                        
                        </li>
                        <div className=" h-9 sm:h-10  bg-pink-500 w-0.5 "></div>
                        <li className='border border-pink-500 rounded p-3 w-40 hover:border-green-500 hover:text-green-500'><a href="#">Work</a></li>

                        <div className="sm:h-10 h-9 bg-pink-500 w-0.5 "></div>
